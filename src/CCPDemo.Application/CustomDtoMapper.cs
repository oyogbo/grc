...
namespace CCPDemo
{
    internal static class CustomDtoMapper
    {
        public static void CreateMappings(IMapperConfigurationExpression configuration)
        {
            ...
            configuration.CreateMap<CreateOrEditRiskRatingDto, RiskRating>().ReverseMap();
            configuration.CreateMap<RiskRatingDto, RiskRating>().ReverseMap();
            configuration.CreateMap<CreateOrEditUsersLookupDto, UsersLookup>().ReverseMap();
            configuration.CreateMap<UsersLookupDto, UsersLookup>().ReverseMap();
